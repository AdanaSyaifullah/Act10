    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tambahBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, com.example.act10.TambahTeman.class);
        ...
        lihatBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(com.example.act10.LihatTeman.getActIntent(MainActivity.this));
            }
        });
    }
